...
- Нельзя добавлять секреты, токены, пароли, приватные ключи, `google-services.json` и `GoogleService-Info.plist`.
...
2. Требуется минимум одно ревью и одобрение maintainers.
