...
class AppColors {
  ...
  // Primary Colors - Coral (из дизайна)
  static const Color primary = Color(0xFFFF7A59); // Новый коралловый
  static const Color primaryLight = Color(0xFFFF9D85);
  static const Color primaryDark = Color(0xFFE65D3D);
  ...
  static const Color badgePaid = Color(
    0xFFFF7B6D,
  ); // Coral для "$15", "$2+" и т.д.
